...
import { getAllCollection } from "./src/firebase/getCollections";
import { type_product } from "./src/types/type_product";
import product from "./src/data/product.json";
import { type_setting } from "./src/types/type_setting";
         ...
         <main className="bg-white relative isolate  pt-14  h-full">
            ...
            {showLogoWhat ? (
               <>
                  ...
                  <a
                     target="blank"
                     href={`https://wa.me/${setting.social_links.whatsapp.trim()}`}
                     className="fixed w-12 bottom-7 right-3  md:w-16 md:bottom-7 md:right-7"
                  >
