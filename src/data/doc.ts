...
export const faq = (contact:string)=> {
  return{
    en:`
    ...
    <div className="lg:w-1/2 px-5 mx-auto policyPrivacy  roboto-regular ">
       ...
       <p className="mt-8 font-bold">1. What types of products do you offer?</p>
       <p className="mt-3">
       We offer a wide range of hair products, hair accessories, slimming girdles, eyelash extensions and
       more.
       </p>
       <p className="mt-8 font-bold">2. How can I place an order?</p>
       <p className="mt-3">
       ...
       <p className="mt-8 font-bold">6. Do you offer samples or promotions?</p>
       <p className="mt-3">
      ...
      <p className="mt-8 font-bold">7. Can I change or cancel my order?</p>
       <p className="mt-3">
       ...
       <p className="mt-8 font-bold">8. How can I contact customer service?</p>
       <p className="mt-3">
       ...
       <p className="mt-8 font-bold">9. Can you cut tulle?</p>
       <p className="mt-3">
       Yes, we can cut the tulle on your wigs, but please note that the return of these will no longer be
        ...
        <p className="mt-8 font-bold">10. What if the product I want is not available?</p>
        <p className="mt-3">
          Call us at 00393289705026 or via WhatsApp so that we can inform you or redirect you to other
          similar options.
        </p>

        <p className="mt-8 font-bold">11. What if I didn't receive the right size or color?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">12. What is a lace wig?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">13. Can I wear a lace wig if I have alopecia?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">14. I have an abundance of hair, is it possible to wear a lace wig?</p>
        <p className="mt-3">
    ...
    <div className="lg:w-1/2 px-5 mx-auto policyPrivacy  roboto-regular ">
       <h1 className="font-medium text-3xl">FAQ</h1>
       <p className="mt-8 font-bold">1. Quels types de produits proposez-vous ?</p>
       <p className="mt-3">
       ...
       <p className="mt-8 font-bold">2. Comment puis-je passer une commande ?</p>
       <p className="mt-3">
       ...
       <p className="mt-8 font-bold">6. Offrez-vous des échantillons ou des promotions ?</p>
       <p className="mt-3">
      ...
      <p className="mt-8 font-bold">7. Les perruques ont-elles des élastiques intégrés ?</p>
       <p className="mt-3">
        Oui, nos perruques sont équipées d'un élastique intégré, permettant un ajustement optimal pour
        un confort accru.
       </p>

       <p className="mt-8 font-bold">8.Puis-je modifier ou annuler ma commande ?</p>
       <p className="mt-3">
      ...
      Nous nous efforcerons de répondre dans les plus brefs délais.
       ...
       <p className="mt-8 font-bold">9. Comment puis-je contacter le service client ?</p>
       <p className="mt-3">
       Vous pouvez nous contacter via notre formulaire de contact sur le site via le lien Whatsapp
        accessible sur le site ou par e-mail à <a className="underline" href="mailto:${contact}">contact@jahairstyle.com</a>.
        Nous nous efforcerons de répondre dans les plus brefs délais.
        ...
        <p className="mt-8 font-bold">10. Pouvez-vous couper la tulle ?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">11.Quelle est la différence entre full lace et lace frontal ?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">12. Quelles sont les types de tulle disponibles ?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">13. Que faire si le produit que je veux n'est pas disponible ?</p>
        <p className="mt-3">
...
vous    rediriger vers d'autres options similaires.
        ...
        <p className="mt-8 font-bold">14. Que faire si je n'ai pas reçu la bonne taille ou couleur ?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">15. Qu'est-ce qu'une perruque lace wig ?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">16. Puis-je porter une lace wig si je souffre d'alopécie ?</p>
        <p className="mt-3">
        ...
        <p className="mt-8 font-bold">17. J'ai une abondance de cheveux, est-il envisageable de porter une
        lace wig ?</p>
        <List className="mt-3  ps-5 text-black">
               <List.Item>
